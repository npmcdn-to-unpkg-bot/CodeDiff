...
namespace MsdrRu.CodeDiff.DiffAlgorithm
{
    /// <summary>
    ...
    public static string TestHelper(Item []f) {
      ...
      return (ret.ToString());
        ...
        /// <returns>Returns a array of Items that describe the differences.</returns>
        public static Item[] DiffText(string TextA, string TextB, bool trimSpace = false, 
            bool ignoreSpace = false, bool ignoreCase = false)
        {
